---
name: skill-writer
description: Creates a new agent skill with the correct directory structure and SKILL.md format. Use this when the user wants to teach the agent a new capability or save a workflow as a reusable skill.
license: MIT
---
...
```bash  theme={null}
nix build .#checks.x86_64-linux.validate-skills
```
